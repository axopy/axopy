...
class RealTimeControl(_BaseTask):
    ...
    def update(self, data):
        ...
        data_proc_ssc = self.ssc.transform(data_proc.T)
        proba = np.max(self.clf.predict_proba(data_proc_ssc))

        self.text_prediction.pos = (-0.35, 0.0)
        self.text_prediction.qitem.setText("Prediction: {}, proba {}".format(pred, proba))
...
if __name__ == '__main__':
    ...
    exp = Experiment(daq=dev, subject='test_2', allow_overwrite=True)
